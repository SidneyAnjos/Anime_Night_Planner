...
if ENDPOINT_NAME in existing_endpoints:
    ...
    try:
        ...
        w.vector_search_endpoints.wait_get_endpoint_ready(ENDPOINT_NAME, timeout=600)
        print(f"Created serverless endpoint '{ENDPOINT_NAME}' (fallback path).")
# COMMAND ----------
# MAGIC %md
...
try:
    w.vector_search_indexes.create_index(
        ...
        delta_sync_index_spec=DeltaSyncVectorIndexSpecRequest(
            ...
            embedding_source_columns=[EmbeddingSourceColumn(name="embedding_vector")],
        ),
    )
...
w.vector_search_indexes.wait_get_index_ready(INDEX_NAME, timeout=600)
